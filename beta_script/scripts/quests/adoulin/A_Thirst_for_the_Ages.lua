...
entity.onTrade = function(player, npc, trade)
    if trade:hasItemQty(638, 1) then  -- Frontier Soda
        if player:hasKeyItem(2894) then  -- Adoulinian Charter Permit
            ...
            player:addKeyItem(1234)  -- Royal Fiat banning colonization
            player:addKeyItem(5678)  -- Record of the 17th Assembly
            player:addKeyItem(9101)  -- Copy of the alliance agreement
