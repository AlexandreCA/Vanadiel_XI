...
zones[xi.zone.RULUDE_GARDENS] =
{
    text =
    {
        ...
        RETURN_ITEMS                     = 6543,  -- The <number> <item> are returned to you.
        ...
        STURDY_WOODEN_CRATE              = 14556, -- A sturdy, sizable wooden crate sits before you.
        ...
        SIGNIFICANTLY_SHOPWORN           = 14563, -- Long years of use have left this once-majestic chest looking significantly shopworn.
