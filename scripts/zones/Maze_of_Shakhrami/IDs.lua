...
zones[xi.zone.MAZE_OF_SHAKHRAMI] =
{
    text =
    {
        ...
        SUBMERGED_ITEM                = 7087,  -- You submerged the <item> into the pool of water.
        MORE_THAN_ONE                 = 7088,  -- You cannot submerge more than one <item> at a time.
        WATER_POOL                    = 7089,  -- Water forms a pool here.
        WAIT_A_BIT_LONGER             = 7090,  -- It does not seem to have become <item> yet. You need to wait a bit longer.
