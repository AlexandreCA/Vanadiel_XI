...
zones[xi.zone.ZHAYOLM_REMNANTS] =
{
    text =
    {
		...
		TEMP_ITEM                     = 7061, -- Obtained temporary item: <item>.																		 
        CELL_OFFSET                   = 7224, -- Main Weapon/Sub-Weapon restriction removed.
		HAVE_TEMP_ITEM                = 7248, -- You already have that temporary item.
        SALVAGE_START                 = 7249, -- You feel an incredible pressure bearing down on you. This area appears to be blanketed in some sort of intense psionic field...
        ...
        PARTY_FALLEN                  = 7429, -- ll party members have fallen in battle. Mission failure in # [minute/minutes].
        DOOR_IS_SEALED                = 7440, -- The door is sealed...
        NOT_RESPONDING                = 7442, -- The device doesn't respond...
