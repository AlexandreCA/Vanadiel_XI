...
zones[xi.zone.HAZHALM_TESTING_GROUNDS] =
{
    text =
    {
		...
		GATE_FIRMLY_CLOSED            = 7223, -- The gate is firmly closed...																	 
		...
		OBTAINS_TEMP_ITEM             = 7990, -- Obtained temporary item: <item>.
        ALREADY_POSSESS_TEMP          = 7991, -- You already have that temporary item.																		 																				  
		STAGNANT_AURA_CLEARED         = 7992, -- The chamber's stagnant aura has somewhat cleared...
        CREATURES_CALMED              = 7993, -- The creatures lurking in the shadows have calmed...
        CREATURES_RESTLESS            = 7994, -- The creatures lurking in the shadows have become restless...
		DENDAINSONNE_ANGRY            = 7999, -- Dendainsonne looks angry...
        DENDAINSONNE_ENRAGED          = 8000, -- Dendainsonne is enraged!
        DENDAINSONNE_OUT_OF_CONTROL   = 8001, -- Dendainsonne is out of control!
        DENDAINSONNE_MOCKING_YOU      = 8002, -- Dendainsonne appears to be mocking you...																																					  
		OTHERWORLDLY_VOICE            = 8039, -- An otherworldly voice echoes faintly from the depths of your skull...
        PROVE_THY_WORTH               = 8040, -- ...who would...prove...thy...worth... Deliver...unto me...and speak...my name...																											  																						 
        FEATHERS_CONSUMED             = 8050, -- All of the valkyrie feathers in your possession are consumed!
        ENTRY_PROHIBITED              = 8051, -- Entry to the chambers is prohibited for # more Vana'dielian [day/days].
        MIN_LEVEL_ENTRY               = 8052, -- Adventurers who have yet to reach level <number> will not be permitted entry to the training grounds.
        RESERVATION_LOCKOUT           = 8053, -- Chamber reservation is prohibited for # more Vana'dielian [day/days].
        MIN_LEVEL_RESERVATION         = 8054, -- Adventurers who have yet to reach level <number> will not be permitted to make reservations within the training grounds.
		COULD_NOT_GATHER_DATA         = 8056, -- Could not gather the sufficient data.																			  
    ...
    mob =
    {
        ...
        HRUNGNIR        = GetFirstID('Hrungnir')[1],
		HRUNGNIR_CLONE  = GetFirstID('Hrungnir')[2],								   
