...
zones[xi.zone.WEST_RONFAURE] =
{
    text =
    {
        ...
        PALCOMONDAU_ENROUTE           = 7393,  -- Let me be! I must patrol the road to Ghelsba.
        PALCOMONDAU_RETURN            = 7394,  -- I bring word of Ghelsba to the Westgate. Out of my way!
        ZOVRIACE_REPORT               = 7395,  -- Scout reporting! All is quiet on the roads to La Theine!
        ZOVRIACE_ENROUTE              = 7396,  -- I must scour the roads to La Theine for signs of the enemy. Let me pass!
        ZOVRIACE_RETURN               = 7397,  -- Let me be! I return to Southgate with word on La Theine.
	...
	TIME_ELAPSED                  = 8057,  -- Time elapsed: <number> [hour/hours] (Vana'diel time) <number> [minute/minutes] and <number> [second/seconds] (Earth time)
