...
zones[xi.zone.LOWER_JEUNO] =
{
    text =
    {
        ...
        LOVE_ROMANCE                  = 7416,  -- Love... Romance... It's all fake! Cursed women are like measles!
        ...
        COULD_HE_BE                   = 7452,  -- Wait, could he be...? Naw, he couldn't be.
        VHANA_DEFAULT                 = 7545,  -- Sorry, I'm busy.
        ...
        DAMANGED_PACKAGE_DELIVERED    = 7691,  -- Due to extensive damage, the <keyitem> are thrown away.
        ...
        DO_NOT_DISTURB                = 7757,  -- "Do Not Disturb"
