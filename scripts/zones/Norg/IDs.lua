...
zones[xi.zone.NORG] =
{
    text =
    {
        ...
        LUCKY_ROLL_EXACT              = 10772, -- And because your roll put the running total at exactly 400, you receive a bonus prize!
        LUCKY_ROLL_CLOSE              = 10773, -- And for bringing the total so close to 400, here is your extra prize!
        LUCKY_ROLL_GAMEOVER           = 10774, -- I'm sorry, but that's it for today's game of Lucky Roll. Come by tomorrow, and maybe Lady Luck will be waiting for you!
