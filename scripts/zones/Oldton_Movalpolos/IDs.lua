...
zones[xi.zone.OLDTON_MOVALPOLOS] =
{
    text =
    {
        ...
        NO_FIRES_NO_BOMBS             = 7721, -- This place being for garbage. No fires. No bombs.
        KILLING_BOMBS                 = 7726, -- Killing bombs. Bringing <item>.
        REFUSES_TO_GIVE_ANOTHER       = 7734, -- When Brakobrik realizes that you already possess the item he is trying to give you, he refuses to give you another one.
