...
zones[xi.zone.HORLAIS_PEAK] =
{
    text =
    {
        ...
        TESTIMONY_IS_TORN             = 7288, -- Your <item> is torn...
        TESTIMONY_WEARS               = 7289, -- Your <item> [/rips into shreds!/is on the verge of tearing apart.../is showing signs of wear...] (# [use remains/uses remain].)
		...
		FALLS_INTO_A_DEEP_SLEEP       = 7951, -- falls into a deep sleep...																   
