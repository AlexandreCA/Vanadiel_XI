...
zones[xi.zone.BONEYARD_GULLY] =
{
    text =
    {
        ...
        BURSTS_INTO_FLAMES            = 7762, -- The <keyitem> suddenly bursts into flames, the blackened remains borne away by the wind...
        GET_YOUR_BLOOD_RACING         = 7812, -- I'll get your blood rrracing!
        SCENT_OF_FRESH_BLOOD          = 7814, -- Ah, the scent of frrresh blood!
